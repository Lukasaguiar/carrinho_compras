...
function Produto({ produto, adicionarAoCarrinho }) {
  ...
  //adicionado o input type number para
  // que podemos botar a quantidade de cada produtos
  return (
    <li>
...
function Carrinho({ itensCarrinho, removerDoCarrinho, atualizarQuantidade, limparCarrinho }) {
  ...
  //adicionamos input type number 
  //no carrinho para podermos editar a quantidade
  //que estao no carrinho 
  return (
    <div>
...
function App() {
  ...
  //passamos o produto e quantidade para a funcao
  const adicionarAoCarrinho = (produto, quantidade) => {
    const itemExistente = itensCarrinho.find((item) => item.id === produto.id);
   
   //se o item ja existe no carrinho nos apenas adicionamos a quantidade
    if (itemExistente) {
      setItensCarrinho(
        
        //caso tentarmos adicionar um item que ja ta na lista.
        // nos somamos o valor que esta na lista com o adicionado agora
      ...
      //se o item nao esta no carrinho 
      // botamos a quantidade e o nome do produto
  ...
  //funcao criada para atualizar a quantiade
